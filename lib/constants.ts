...
export const PREMIUM_WEEKLY_BUNDLE_PAYMENT_LINK = env.NEXT_PUBLIC_PREMIUM_WEEKLY_BUNDLE_PAYMENT_LINK
export const PREMIUM_MONTHLY_BUNDLE_PAYMENT_LINK =
  env.NEXT_PUBLIC_PREMIUM_MONTHLY_BUNDLE_PAYMENT_LINK
