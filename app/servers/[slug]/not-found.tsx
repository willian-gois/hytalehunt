    ...
    <div className="bg-secondary/20 flex min-h-[80vh] items-center justify-center">
      <div className="mx-auto max-w-2xl px-4 py-12 text-center">
        <div className="bg-background rounded-xl border p-8 shadow-sm dark:border-zinc-800">
          ...
          <h1 className="font-heading mb-3 text-3xl font-bold">Server Not Found</h1>
          <p className="text-muted-foreground mx-auto mb-8 max-w-md">
            The server you&apos;re looking for doesn&apos;t exist or may have been removed. It might
            be a server that was abandoned during the payment process.
          </p>
